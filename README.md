# Portfolio de Steeven - Développeur Web

Bienvenue sur le dépôt de mon portfolio personnel. Ce projet a été conçu pour présenter mes compétences, mes projets et mes expériences en tant que développeur web passionné.

## À propos de moi

Je suis Steeven, un développeur web spécialisé dans la création d'expériences numériques élégantes et performantes. Passionné par la technologie et le design, je m'efforce de concevoir des interfaces intuitives, esthétiques et accessibles à tous.
...
| Expérience                       | Description                                                                                             | Compétences clés                                     |
| -------------------------------- | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| **Stage chez Netir.fr**          | Intégration de maquettes Figma en composants fonctionnels avec Plasmic.                                 | Intégration web, Plasmic, Figma, Rigueur             |
| **Freelance en Graphisme**       | Création de logos, affiches et supports promotionnels pour divers clients.                            | Créativité, Communication client, Gestion de projets |
| **Modélisation 3D**              | Modélisation 3D d'une boutique pour un client, de la prise de mesures à la visualisation avec SketchUp. | SketchUp, Modélisation 3D, Planification           |
...
Pour visualiser le projet sur votre machine, suivez ces étapes :
